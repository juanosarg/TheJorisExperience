...
{
    public class Projectile_Holy : Projectile
    {
        ...
        protected override void Impact(Thing hitThing, bool blockedByShield = false)
        {
            ...
            if (hitThing != null)
            {
                ...
                {
                    MiniOrbitalStrike powerBeam = (MiniOrbitalStrike)GenSpawn.Spawn(ThingDef.Named("JE_PowerBeam"), hitThing.Position, map, WipeMode.Vanish);
